...
const reasons = [
  {
    ...
    description:
      "המוצר ישראלי, אבל הקונה יושב בניו יורק או בלונדון. ההודעות, התוכן והקמפיינים נכתבים באנגלית ברמת שפת אם, על ידי מי שמכירה את הקונה הזה מבפנים אחרי יותר מ-15 שנה ב-B2B Tech.",
  },
  {
