...
export const metadata: Metadata = {
  ...
  description:
    "B2B marketing in Israel built to sell globally. Senior strategy from Lihi Pinto plus 8 supervised AI agents, for Israeli B2B and SaaS companies going to the US and Europe.",
