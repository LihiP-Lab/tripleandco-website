...
const pillars = [
  {
    ...
    description:
      "יותר מ-15 שנות ניסיון ב-B2B Tech, יותר מ-$70M גויסו בחברות שבהן הובילה את השיווק, וההכנסות שולשו שוב ושוב. מיצוב, הודעות, ארכיטקטורת פייפליין ודיווח להנהלה יושבים אצל מנהלת אחת שאחראית לתוצאה.",
  },
  {
